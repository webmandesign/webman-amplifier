										...
										'general' => array(
											...
											'fields' => array(
												...
												'children' => array(
													'type' => 'form',
													//description
													'label'       => __( 'Item', 'wm_domain' ),
													'description' => '',
													'help'        => '',
													//default
													'default' => array( 'title' => __( 'Item', 'wm_domain' ) ), //This will be converted automatically
													//type specific
				...
				'vc_plugin'  => array(
						...
						'params'                  => array(
								10 => array(
									...
									'description' => __( 'Set "0" for all sections closed', 'wm_domain' ),
									'type'        => 'textfield',
									'param_name'  => 'active',
									'value'       => 0,
									'holder'      => 'hidden',
