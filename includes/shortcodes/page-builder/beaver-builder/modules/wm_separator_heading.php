 ...
 */
	 ...
	 */
	class WM_BB_Module_Separator_heading extends FLBuilderModule {

		public function __construct() {

			$module = wma_bb_get_custom_module_slug( __FILE__ );

			parent::__construct( apply_filters( 'wmhook_wmamp_' . 'bb_module_construct_' . $module, array(
	...
	} // /WM_BB_Module_Separator_heading
 ...
 */
	...
	if ( ! empty( $module_form ) && is_array( $module_form ) ) {
		FLBuilder::register_module( 'WM_BB_Module_Separator_heading', $module_form );
	}
